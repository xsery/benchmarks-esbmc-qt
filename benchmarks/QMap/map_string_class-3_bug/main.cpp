...
int main()
{
  ...
  QMapObject.insert( QMap<StringClass, opposite>::value_type(StringClass("y"),opposite("n")) );
  QMapObject.insert( QMap<StringClass, opposite>::value_type(StringClass("a"),opposite("b")) );
  QMapObject.insert( QMap<StringClass, opposite>::value_type(StringClass("c"),opposite("d")) );

  QMap<StringClass, opposite>::iterator it = QMapObject.begin();
  assert(it.key() == StringClass("c"));
