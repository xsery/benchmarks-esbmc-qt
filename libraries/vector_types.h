...
struct __device_builtin__ __dim3
{
    ...
    __host__ __device__ __dim3(unsigned int vx = 1, unsigned int vy = 1, unsigned int vz = 1){ x = vx; y = vy; z = vz;}
    __host__ __device__ __dim3(uint3 v){ x = v.x; y = v.y; z = v.z;}
    __host__ __device__ __dim3(__dim3 d){x = d.x; y = d.y; z = d.z;}
